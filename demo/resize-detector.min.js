!(function (e, r) {
  ...
  function _(e, r, t) {
    return (window.getComputedStyle(e, t || null) || { display: 'none' })[r]
  }
  function n(e) {
    if (!document.documentElement.contains(e))
      return { detached: !0, rendered: !1 }
    for (var r = e; r !== document; ) {
      if ('none' === _(r, 'display')) return { detached: !1, rendered: !1 }
      r = r.parentNode
    }
  ...
  function d() {
    var e = n(this),
      r = e.rendered,
      t = e.detached
    r !== this.__resize_rendered__ &&
      (!t &&
        this.__resize_triggers__ &&
        (c(this), this.addEventListener('scroll', a, !0)),
      (this.__resize_rendered__ = r),
      l(this))
  }
  function a() {
    var e,
      ...
      (this.__resize_raf__ =
        ((i = function () {
          var e,
            ...
            s,
            o =
              ((r = (e = _).__resize_last__),
              (t = r.width),
              (i = r.height),
              (n = e.offsetWidth),
              (s = e.offsetHeight),
              n !== t || s !== i ? { width: n, height: s } : null)
  ...
  function l(e) {
    e &&
      ...
      e.__resize_listeners__.forEach(function (r) {
        r.call(e, e)
      })
  }
  function c(e) {
  ...
  ;(e.addListener = function (e, r) {
    if (
      (e.__resize_mutation_handler__ ||
        (e.__resize_mutation_handler__ = d.bind(e)),
      !e.__resize_listeners__)
    )
      if (((e.__resize_listeners__ = []), window.ResizeObserver)) {
        var t = e.offsetWidth,
          ...
          u = new ResizeObserver(function () {
            ;(e.__resize_observer_triggered__ ||
              ...
              e.offsetWidth !== t || e.offsetHeight !== h)) &&
              l(e)
          }),
          f = n(e),
          z = f.detached,
          v = f.rendered
        ;(e.__resize_observer_triggered__ = !1 === z && !1 === v),
          (e.__resize_observer__ = u),
          u.observe(e)
        ...
        (function (e) {
          var r = _(e, 'position')
          ;(r && 'static' !== r) || (e.style.position = 'relative')
          ;(e.__resize_old_position__ = r), (e.__resize_last__ = {})
          var t = i('div', { className: 'resize-triggers' }),
            n = i('div', { className: 'resize-expand-trigger' }),
            s = i('div'),
            o = i('div', { className: 'resize-contract-trigger' })
          n.appendChild(s),
            t.appendChild(n),
            t.appendChild(o),
            e.appendChild(t),
        ...
        (e.__resize_rendered__ = n(e).rendered),
        window.MutationObserver)
      ) {
        var g = new MutationObserver(e.__resize_mutation_handler__)
        g.observe(document, {
          attributes: !0,
          childList: !0,
          characterData: !0,
          ...
          (e.__resize_mutation_observer__ = g)
      }
    e.__resize_listeners__.push(r), s++
  }),
    (e.removeListener = function (e, r) {
      ...
      if (t) {
        ...
        !--s && o && o.parentNode.removeChild(o)
      }
    }),
